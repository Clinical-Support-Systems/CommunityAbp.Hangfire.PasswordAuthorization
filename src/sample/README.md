# CommunityAbp.Hangfire.PasswordAuthorization.DemoSite
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 48c4b2dd-8f14-4781-ac78-6ab58dc307e8
```

> `48c4b2dd-8f14-4781-ac78-6ab58dc307e8` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the `CommunityAbp.Hangfire.PasswordAuthorization.DemoSite` directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disabled it.
