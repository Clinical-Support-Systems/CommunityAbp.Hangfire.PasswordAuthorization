...
public class DemoSiteDbMigrationService : ITransientDependency
{
    public ILogger<DemoSiteDbMigrationService> Logger { get; set; }
    ...
    public DemoSiteDbMigrationService(
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<DemoSiteDbMigrationService>.Instance;
    }
